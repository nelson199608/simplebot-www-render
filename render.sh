...
python3 -c "import requests; r=requests.get('https://github.com/adbenitez/nelson199608/raw/master/scripts/web_search.py'); open('web_search.py', 'wb').write(r.content)"
